...
Estudante de Engenharia de Software e Aprendiz de TI, atuando com suporte técnico N1 
e SQL Server no meu dia a dia profissional. Em paralelo, venho me dedicando ao 
estudo de desenvolvimento, com foco em C# e .NET.

🔧 Estudando e praticando **C#, .NET e lógica de programação**, com foco em 
construir uma base sólida antes de avançar para projetos mais complexos.
...
-   💻 Lógica de programação e Programação Orientada a Objetos (C#)
-   🗄️ Banco de dados relacional (SQL Server)
-   🔧 Aplicações CRUD (console, evoluindo para outras interfaces)
-   🌐 Fundamentos de APIs REST
-   🔀 Versionamento de código com Git & GitHub
-   ☁️ Explorando fundamentos de Cloud (AWS/Azure)
-   🎯 Suporte técnico N1 e resolução de chamados no dia a dia profissional
---
...
![Html5](https://img.shields.io/badge/Html5-FFD43B?style=for-the-badge&logo=html5&logoColor=000)
![Css3](https://img.shields.io/badge/Css3-FFD43B?style=for-the-badge&logo=Css3&logoColor=000)
